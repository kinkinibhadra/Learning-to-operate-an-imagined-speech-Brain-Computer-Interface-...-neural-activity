...
OUTDIR_data = 'D:\2022_Battery_protocol_data\Analysis\ERDS_wavelet\Data\Power_Modulation_v2\';
% OUTDIR_plot = 'D:\2022_Battery_protocol_data\Analysis\ERDS_wavelet\plots\';


%% Inputs
% 1- time series of interest:
toi_low = -4; % in seconds
toi_high = 8; % in seconds
toi_base_low = -3;
toi_base_high = -2;
...
for i_sub = 1 :length(subj_info)
    ...
    for i_day = 1 :length(day_info)
        ...
        % saving the data
        savefast([OUTDIR_data 'Power_' subject_name '_Day_',num2str(i_day) '.mat'],'Power');
